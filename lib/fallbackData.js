...
export const FALLBACK_PROJECTS = [
  ...
  },
  {
    ...
    short_description: 'Event ticket booking mobile app — engineered an interactive, high-performance seat layout in native React Native code, replacing legacy WebView rendering.',
    full_description: 'A company project — an event ticket booking mobile application. Originally built with a WebView-based seat layout, Rohit completely re-architected and rebuilt the entire interactive seating selection system using pure native React Native code. This eliminated WebView overhead, dramatically improved touch responsiveness, reduced memory usage, and delivered a seamless, high-performance native seating reservation experience for users. Related website: https://www.ticketkhidakee.com/',
    tech_stack: ['React Native', 'Native UI Architecture', 'State Management', 'REST APIs'],
